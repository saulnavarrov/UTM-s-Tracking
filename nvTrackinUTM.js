 ...
 * UTM Trackers
 * 
 * @autor SaúlNavarrov || Utmtracker.js
 * @email symbioxisdigital@gmail.com
 * @date 20220901
 * @description Funciona para guardar las utms generadas
 * desde publicidad o alguna generada
 */
function readCookieUtm(name) {
  var c, ca, i, nameEQ;
  var cookieNamePrefix = "_n4v_";
  nameEQ = cookieNamePrefix + name + '=';
...
UtmCookie = class UtmCookie {
  constructor(options = {}) {
    ...
    this._utmParams = ['utm_source', 'utm_medium', 'utm_campaign', 'utm_term', 'utm_content','utm_id'];
...
UtmForm = class UtmForm {
  constructor(options = {}) {
    ...
    this._addToForm = options.add_to_form || 'none';
